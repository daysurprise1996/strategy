...
import com.daysurprise.strategy.enums.CharsetEnum;
import com.daysurprise.strategy.enums.ContentTypeEnum;
import com.daysurprise.strategy.enums.MIMETypeEnum;
...
public class HttpUtils {
     ...
     */
    /*
     * public static String post(String url, Map<String, String> params, String inputName, String filePath) { return
     * post(url, params, inputName, new File(filePath)); }
     */
     ...
     */
    /*
     * public static String post(String url, Map<String, String> params, String inputName, File file) { Map<String,
     * File> files = new HashMap<>(1); files.put(inputName, file); return post(url, params, files); }
     */
     ...
     */
    /*
     * public static String post(String url, Map<String, String> params, Map<String, File> files) { HttpPost httpPost =
     * new HttpPost(url); MultipartEntityBuilder multipartEntityBuilder = MultipartEntityBuilder.create();
     * Set<Map.Entry<String, String>> paramEntrySet = params.entrySet(); for (Map.Entry<String, String> entry :
     * paramEntrySet) { multipartEntityBuilder.addPart(entry.getKey(), new StringBody(entry.getValue(),
     * ContentType.TEXT_PLAIN)); } Set<Map.Entry<String, File>> fileEntrySet = files.entrySet(); for (Map.Entry<String,
     * File> entry : fileEntrySet) { multipartEntityBuilder.addPart(entry.getKey(), new FileBody(entry.getValue())); }
     * HttpEntity entity = multipartEntityBuilder.build(); httpPost.setEntity(entity); return send(NONE_GET, httpPost,
     ...
     */
    public static String post(String url, String data, MIMETypeEnum dataTypeEnum, List<Cookie> cookieList,
                              boolean getCookie) {
        HttpPost httpPost = new HttpPost(url);
        httpPost.addHeader("Content-type", dataTypeEnum.getMime() + "; charset=" + CharsetEnum.UTF8.getValue());
        httpPost.addHeader("Accept", dataTypeEnum.getMime());
     ...
     */
    private static <T> T send(HttpGet httpGet, HttpPost httpPost, List<Cookie> cookieList, boolean getCookie,
