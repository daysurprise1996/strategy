 ...
 * @author wangjie
 * @version V1.0
 * @date 2020/4/10 17:33
 * @desc:
 * @className com.daysurprise.strategy.enums.MIMETypeEnum
 */
public enum MIMETypeEnum {

                          TEXT("text", ".txt", "text/plain"), HTML("html", ".html", "text/html"),
                          XML("xml", ".xml", "text/xml"), JSON("json", ".json", "application/json"),
                          JPG("jpg", ".jpg", "image/jpeg"), JPEG("jpeg", ".jpeg", "image/jpeg"),
                          GIF("gif", ".gif", "image/gif"), PNG("png", ".png", "image/png"),
                          BMP("bmp", ".bmp", "image/bmp"), PDF("pdf", ".pdf", "application/pdf"),
                          ...
                          ZIP("zip", ".zip", "application/zip"), RAR("rar", ".rar", "application/x-rar-compressed");
